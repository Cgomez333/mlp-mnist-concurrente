...
pip install -r py_multiprocessing/requirements.txt

# Entrenar con 4 procesos usando IDX
python py_multiprocessing/src/train_mp.py --data-root data/mnist --epochs 5 --batch-size 512 --hidden-dim 512 --seed 42 --workers 4

# Entrenar con BIN
python py_multiprocessing/src/train_mp.py --data-root data/mnist --use-bin --epochs 5 --batch-size 512 --hidden-dim 512 --seed 42 --workers 4
```
