...
# Entrenar (usando IDX)
cd src
python train.py --epochs 5 --batch-size 256 --hidden-dim 512 --seed 42

# Entrenar (usando BIN generados por preprocess_for_c.py)
python train.py --use-bin --epochs 5 --batch-size 256 --hidden-dim 512 --seed 42
```
